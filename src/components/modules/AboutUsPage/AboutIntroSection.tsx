      ...
      <div className="container mx-auto px-6 lg:px-12">
        <div className="grid items-center gap-12 lg:grid-cols-2">
          <div className="space-y-8">
            <div className="space-y-5">
              ...
              <p className="max-w-lg text-base leading-7 text-gray-500">
                Skills Lab Consultancy is a premier educational advisory firm
                dedicated to bridging the gap between local talent and global
                opportunities.
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-5">
              ...
              <Card className="rounded-2xl border border-gray-100 bg-white shadow-sm">
                <CardContent className="flex items-center gap-3 px-5 py-4">
                  ...
                  <div>
                    <h4 className="text-lg font-bold text-orange-500">500+</h4>
          ...
          <div className="relative flex justify-center">
            ...
            <div className="absolute lg:left-[-144px] lg:bottom-[-57px] md: rounded-2xl bg-[#2563EB] px-6 py-5 text-white shadow-2xl">
              <h3 className="text-3xl font-bold text-[#F97316]">2+</h3>

              <p className="mt-2 max-w-[210px] text-sm leading-6 text-blue-100">
                Years of consultancy expertise in global admissions and visa
                processing.
              </p>
            </div>
          </div>
